...
export function MobileNav() {
  ...
  return (
    <>
      {moreOpen && (
        <div className="fixed inset-0 z-20 flex items-end md:hidden">
          ...
          <div
            ...
            className="relative w-full rounded-t-lg border-t border-border bg-bg p-4"
          >
      ...
      <nav
        aria-label="Primary"
        className="fixed inset-x-0 bottom-0 z-10 flex border-t border-border bg-bg pb-[env(safe-area-inset-bottom)] md:hidden"
      >
