  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-wrap items-end gap-2">
      <div className="flex flex-col gap-1">
        <label htmlFor="wallet-label" className="text-xs font-medium text-slate-400">
          Label
        </label>
        <input
          id="wallet-label"
          ...
          required
          className="w-40 rounded-md border border-slate-800/80 bg-slate-800 px-2 py-1 text-sm text-slate-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
        />
      </div>
      <div className="flex flex-1 flex-col gap-1">
        <label htmlFor="wallet-address" className="text-xs font-medium text-slate-400">
          Public address (0x…)
        </label>
        <input
          id="wallet-address"
          ...
          placeholder="0x…"
          required
          className="w-full rounded-md border border-slate-800/80 bg-slate-800 px-2 py-1 font-tabular-figures tracking-tight text-sm text-slate-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
        />
      </div>
      <button
        type="submit"
        disabled={isSubmitting}
        className="uv-btn-press flex items-center gap-1.5 rounded-md border border-slate-800/80 bg-accent px-3 py-1.5 text-sm font-medium text-bg hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:opacity-50"
      >
