      ...
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        {!isAdding && (
          <button
            ...
            disabled={isBusy}
            className="uv-btn-press flex items-center gap-1.5 rounded-md border border-border px-3 py-1 text-xs font-medium text-fg hover:bg-elevated-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:opacity-50"
          >
            Add a passkey
          </button>
        )}
