        ...
        {setupData && (
          <div className="mt-4 flex flex-col items-start gap-3">
            ...
            <p className="text-xs text-muted">
              ...
              <code className="font-tabular-figures tracking-tight text-fg">{setupData.secret}</code>
            </p>
            <form onSubmit={handleConfirmSetup} className="flex flex-wrap items-end gap-2">
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  className="w-32 rounded-md border border-border bg-elevated px-2 py-1 text-sm font-tabular-figures tracking-tight text-fg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                />
              </div>
              <button
                type="submit"
  ...
  return (
    <section className="flex flex-wrap items-center gap-2 rounded-lg border border-border bg-surface p-3 text-sm">
      ...
      <button
        ...
        disabled={isBusy}
        className="uv-btn-press ml-auto flex items-center gap-1.5 rounded-md border border-border px-3 py-1 text-xs font-medium text-fg hover:bg-elevated-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:opacity-50"
      >
