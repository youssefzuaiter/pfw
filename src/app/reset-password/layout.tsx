 ...
 * that file's doc comment for the full reasoning. Covers the
 * `[token]/` subroute automatically (a nested layout applies to every
 * page beneath it), so no separate layout file is needed there.
 */
