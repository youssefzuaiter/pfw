      ...
      <form onSubmit={handleRecoverySubmit} className="mt-6 flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            className="rounded-md border border-border bg-surface px-3 py-2 text-sm text-fg placeholder:text-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
          />
        </div>
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            className="rounded-md border border-border bg-surface px-3 py-2 text-sm text-fg font-tabular-figures tracking-tight placeholder:text-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
          />
        </div>
        <button
          type="submit"
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      ...
      <button
        ...
        disabled={isSubmitting}
        className="uv-btn-press flex items-center justify-center gap-2 rounded-md border border-border px-4 py-2 text-sm font-medium text-fg transition-colors hover:bg-elevated-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:opacity-50"
      >
        {isSubmitting && <Spinner />}
