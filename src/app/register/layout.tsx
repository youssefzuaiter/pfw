 ...
 * that file's doc comment for the full reasoning (matches
 * `(finance)/layout.tsx`/`/trading/layout.tsx`'s mechanism, doesn't hide
 * `Sidebar`/`MobileNav`, a plain `<div>` not `<main>`).
 */
