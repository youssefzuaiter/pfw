      ...
      <section className="flex flex-col gap-4 rounded-lg border-2 border-positive bg-surface p-4">
        ...
        <ul className="flex flex-col gap-3">
          {recoveredDocuments.map((doc) => (
            <li key={doc.id} className="rounded-md border border-border bg-elevated p-3">
        ...
        <>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-2">
            ...
            <textarea
              ...
              className="rounded-md border border-border bg-elevated px-2 py-1 font-tabular-figures tracking-tight text-xs text-fg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
