/**
 * `/advisor`'s own fixed institutional-terminal shell — same mechanism
 * (and reasoning) as `(finance)/layout.tsx`'s and `/trading/layout.tsx`'s
 * fixed dark shells: a deliberate, fixed visual choice for this screen,
 * not something a user's light/dark theme preference should be able to
 * invert.
 *
