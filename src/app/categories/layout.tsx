/**
 * Categories' own fixed institutional-terminal shell — same mechanism
 * (and reasoning) as `(finance)/layout.tsx`'s shared shell and
 ...
 * be able to invert.
 *
 * Scoped per-route rather than shared, since `/categories` isn't part of
 * the `(finance)` route group.
 *
