      ...
      <div role="search" className="flex flex-wrap items-center gap-3">
        ...
        <div className="relative min-w-[220px] flex-1">
          <input
            ...
            className="w-full rounded-md border border-border bg-elevated px-3 py-2 text-sm text-fg placeholder:text-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
          />
          {mode === "searching" && (
