            ...
            {(stage === "idle" || stage === "error") && (
              ...
              >
                ...
                <button
                  ...
                  className="uv-btn-press rounded-md border border-transparent bg-accent px-3 py-1.5 text-sm font-medium text-bg hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                >
                  Choose a file
                </button>
                <input
