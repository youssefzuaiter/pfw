        ...
        {conditions.map((condition, index) => (
          <div key={index} className="flex flex-wrap items-center gap-2">
            <select
              ...
              className="rounded-md border border-border bg-elevated px-2 py-1.5 text-sm text-fg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
            >
            ...
            <input
              ...
              className="min-w-[160px] flex-1 rounded-md border border-border bg-elevated px-3 py-1.5 text-sm text-fg placeholder:text-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
            />
            {conditions.length > 1 && (
              <button
                type="button"
                ...
                className="uv-btn-press rounded-md border border-border px-2 py-1 text-xs text-muted hover:bg-elevated-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              >
                Remove
              </button>
            )}
          ...
          <div key={index} className="flex flex-wrap items-center gap-2">
            ...
            {action.type === "categorize" && (
              <select
                ...
                className="min-w-[160px] flex-1 rounded-md border border-border bg-elevated px-2 py-1.5 text-sm text-fg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              >
