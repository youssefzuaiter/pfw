  ...
  return (
    <div className="flex flex-col gap-4">
      <section className="rounded-lg border border-border bg-surface p-4">
        <h2 className="mb-3 text-xs font-medium uppercase tracking-wide text-muted">Shared envelopes</h2>
          ...
          <ul className="flex flex-col gap-2">
            {envelopeAllocations.map((allocation) => (
              <li key={allocation.id} className="flex flex-wrap items-center justify-between gap-2 border-t border-border pt-2 first:border-t-0 first:pt-0">
                ...
                <p className="font-tabular-figures text-sm tracking-tight text-fg">
      ...
      <section className="rounded-lg border border-border bg-surface p-4">
        <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
          <h2 className="text-xs font-medium uppercase tracking-wide text-muted">Shared accounts</h2>
              ...
              <li key={account.id} className="flex flex-wrap items-center justify-between gap-2 border-t border-border pt-2 first:border-t-0 first:pt-0">
                ...
                <div className="text-right">
                  <CurrencyAmount
                    ...
                    primaryClassName="font-tabular-figures text-sm tracking-tight text-fg"
                    secondaryClassName="font-tabular-figures text-xs tracking-tight text-muted"
                  />
                </div>
              </li>
            ))}
      ...
      <section className="rounded-lg border border-border bg-surface p-4">
        <h2 className="mb-3 text-xs font-medium uppercase tracking-wide text-muted">Shared categories</h2>
        {categories.length === 0 ? (
